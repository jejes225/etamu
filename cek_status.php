<?php
// cek_status.php - Cek Status DPRD Provinsi Lampung
include 'koneksi.php';

$results = [];
$searched = false;

if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['cari'])) {
      ...
      <div class="main-card rounded-[30px] overflow-hidden">
        ...
        <div class="hero px-6 sm:px-10 pt-10 pb-24 text-white">
          ...
          <div class="relative z-10 text-center">
            ...
            <p class="hero-desc mt-5 max-w-md mx-auto text-sm sm:text-[15px] text-white/85 leading-relaxed">
              Cek status pendaftaran tamu secara cepat, aman, modern, dan profesional langsung dari sistem digital DPRD Provinsi Lampung.
            </p>
        ...
        <div class="px-4 sm:px-7 pb-8 -mt-14 relative z-20">
          ...
          <div class="glass rounded-[28px] shadow-2xl border border-white/60 p-5 sm:p-6">
            ...
            <form method="POST" action="" class="space-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input type="text"
                    ...
                    class="search-input w-full h-14 sm:h-16 rounded-2xl border border-slate-200 bg-slate-50 px-5 pr-14 text-sm sm:text-[15px] focus:outline-none focus:ring-0">
              ...
              <button type="submit"
                class="search-btn w-full h-14 sm:h-16 rounded-2xl bg-gradient-to-r from-yellow-600 via-yellow-700 to-amber-700 text-white font-bold tracking-wide shadow-xl active:scale-[0.98]">
            ...
            <div class="mt-7">
              ...
              <?php if (empty($results)): ?>
                ...
                <div class="glass rounded-[28px] p-8 sm:p-10 text-center shadow-xl border border-white/60">
                  ...
                  <p class="mt-3 text-sm sm:text-[15px] text-slate-500 leading-relaxed max-w-sm mx-auto">
                    Tidak ada data pendaftaran dengan nama yang Anda masukkan.
                  </p>
                ...
                <div class="space-y-5">
                  ...
                  <?php foreach ($results as $row): ?>
                    ...
                    <div class="result-card glass rounded-[28px] border border-white/60 overflow-hidden shadow-xl">
                      ...
                      <div class="result-padding p-5 sm:p-6">

                        <!-- TOP -->
                        <div class="flex items-start justify-between gap-4 mobile-stack">

                          <div class="flex items-start gap-4 flex-1 mobile-full">
                          ...
                          <div class="<?= $statusClass ?> mobile-status px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap">
                        ...
                        <div class="mt-5 grid gap-3">
                          ...
                          <?php if (!empty($row['destination'])): ?>
                            ...
                            <div class="bg-slate-50 rounded-2xl p-4">
                              ...
                              <p class="text-sm text-slate-700 font-medium mt-1 leading-relaxed break-words">
                        ...
                        <a href="status.php?id=<?= $row['id'] ?>"
                          class="mt-5 flex items-center justify-center w-full h-12 sm:h-14 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-900 hover:from-black hover:to-slate-800 transition-all duration-300 text-white font-semibold shadow-lg active:scale-[0.98]">
